...
//   const[progressArray,setProgresssArray] = useState(null)
...
//       course.courseRatings.map((items)=> {
...
// //     if(data.success) {
// //       setProgresssData(data.progressData)
// //     } else {
// //       toast.error(data.message)
// //     }
// //   } catch (error) {
...
//                                   <p>{humanizeDuration(
//                                     lecture.lectureDuration * 60*1000,{units:['h','m']})}</p>
//                                 </div>
//                               </div>
//                             </li>
//                           ))}
